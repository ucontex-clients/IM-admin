...
export default function PropertyLayout(props) {
  ...
  let createLayout = async () => {
    ...
    let url =
      'https://im-property.herokuapp.com/api/property/addplot/' + propertyId
    ...
    <div className=" w-full flex flex-col ">
      ...
      <div className=" w-full flex ">
        <div className=" w-full mr-3 overflow-y-auto flex flex-col font-Montserrat-Medium mt-4 p-6 pb-12 border rounded-lg ">
          <p className=" my-6 font-Montserrat-Bold text-xl ">
            About Property Info
          </p>
          ...
          <div className=" w-full mt-3 border border-[#000000] rounded-md p-6 ">
            ...
            <div className=" w-full flex mt-6 ">
              <div className=" w-full mr-4 ">
                ...
                <button className=" w-full bg-[#C6C5C5] h-[45px] rounded-md">
                  {Math.round(price * length * width * 10) / 10}
                </button>
              </div>
              <div className=" w-full "></div>
            </div>
            <button
              className=" w-full bg-[#3DB2FF] h-[45px] text-white rounded-md mt-10  font-Inter-Bold "
              ...
              {layoutMap?.map((e, i) => {
                return (
                  <div className=" w-full  flex flex-col border border-[#C6C5C5] relative rounded-md ">
                    <p className=" text-center font-Montserrat-Regular text-xs absolute rotate-90 -left-[10px] top-6 ">
                      {e.width}m
                    </p>
                    <p className=" text-center font-Montserrat-Regular text-xs ">
                      {e.length}m
                    </p>
                    <p className=" text-center font-Montserrat-Bold text-xs my-2 text-[#000] ">
                      {e.area} SQ.M
                    </p>
                    <p className=" text-center font-Montserrat-SemiBold text-xs text-[#3DB2FF] ">
                      N{e.price}
                    </p>
                  </div>
                )
      ...
      <button
        ...
        className=" bg-[#3DB2FF] mx-auto w-[300px] h-[45px] mt-8 rounded-md text-white font-Inter-Bold "
      >
        Preview
      </button>
    </div>
