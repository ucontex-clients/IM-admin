  ...
  React.useEffect(() => {
    fetch(`https://www.universal-tutorial.com/api/getaccesstoken`, {
      ...
      headers: {
        ...
        'api-token':
          'V1mhwD-iZGLntVICiPhQfxRIhGpJ1xcokq0xZiMbq9YfK2VcXy0EikVGhfxI6RH-RLE',
    ...
    return (
      <div className=" w-[600px] overflow-y-auto flex flex-col font-Montserrat-Medium mt-4 p-6 pb-12 border rounded-lg ">
        ...
        <div className="w-full">
          <p className=" text-[15px] mt-6 font-Inter-SemiBold mb-2 ">
            Name of Property
          </p>
          <TextField
            name="name"
        ...
        <div className="w-full">
          ...
          <TextField
            ...
            rows={4}
            onChange={formik.handleChange}
            onFocus={() => formik.setFieldTouched('about', true, true)}
        ...
        {/* <div className="w-full">
          ...
          <Input
            ...
            placeholder="Residential or Industrial"
            height="45px"
        ...
        <Grid container spacing={2}>
          <Grid item md={4}>
            <TextField placeholder="Nigeria" fullWidth select>
          ...
          <Grid item md={4}>
            <TextField
              name="state"
              onChange={formik.handleChange}
              onFocus={() => formik.setFieldTouched('state', true, true)}
              placeholder="State"
              select
              fullWidth
            >
          ...
          <Grid item md={4}>
            <TextField
              name="LGA"
              onChange={formik.handleChange}
              onFocus={() => formik.setFieldTouched('LGA', true, true)}
              placeholder="LGA"
              fullWidth
            />
            <div className="w-full h-auto pt-2">
        ...
        <Grid container spacing={2}>
          <Grid item md={6}>
            <TextField
              name="city"
              onChange={formik.handleChange}
              onFocus={() => formik.setFieldTouched('city', true, true)}
              placeholder="City"
              fullWidth
            />
            <div className="w-full h-auto pt-2">
          ...
          <Grid item md={6}>
            <TextField
              name="address"
              onChange={formik.handleChange}
              onFocus={() => formik.setFieldTouched('address', true, true)}
              placeholder="Address"
              fullWidth
            />
            <div className="w-full h-auto pt-2">
        ...
        {/* <div className="flex mt-5 gap-4">
          ...
          <div className=" w-full  ">
            ...
            <Input
              name="pricePerSm"
              onChange={formik.handleChange}
              onFocus={() => formik.setFieldTouched('pricePerSm', true, true)}
        ...
        <TextField
          ...
          onChange={formik.handleChange}
          onFocus={() => formik.setFieldTouched('propertyFeatures', true, true)}
          placeholder="Enter the Address of the property"
          fullWidth
        />
        <div className="w-full h-auto pt-2">
          {formik.touched.propertyFeatures &&
        ...
        <Input
          name="estateFeatures"
          onChange={formik.handleChange}
          onFocus={() => formik.setFieldTouched('estateFeatures', true, true)}
          placeholder="Enter the features of the Estate"
          height="45px"
          border=" 1px solid #000 "
        />
        <div className="w-full h-auto pt-2">
        ...
        <p className=" my-2 font-Montserrat-Bold  ">Media</p>
        <br />
        ...
        <Box sx={{ pb: 4, pt: 4 }}>
          <p className=" text-[15px] font-Inter-SemiBold mb-2 ">Upload Video</p>
        ...
        <button
          onClick={() => submit()}
          className=" bg-[#3DB2FF] mx-auto w-[300px] h-10 mt-8 rounded-md text-white font-Inter-Bold "
        >
          Next
        </button>
      </div>
