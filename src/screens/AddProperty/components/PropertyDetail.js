...
export default function PropertyDetails(props) {
    ...
    const formik = useFormik({
        initialValues: {name: '', about: '', features: '', category: '', state: '', city: '', address: '', LGA: '', color: '#333'},
    ...
    const submit = async () => {
        ...
        //   alert('You have to fill in the form correctly to continue');
          ...
          return;
            ...
            props.value({name: formik.values.name, pricePerSm: formik.values.pricePerSm, about: formik.values.about, features: formik.values.features, category: formik.values.category, state: formik.values.state, city: formik.values.city, address: formik.values.address, LGA: formik.values.LGA, color: formik.values.color, images: imageFiles})
            props.next(true)
        }
        // props.next(true)
    } 
        ...
        return (
            <div className=' w-[600px] overflow-y-auto flex flex-col font-Montserrat-Medium mt-4 p-6 pb-12 border rounded-lg ' > 
                ...
                <Input 
                    ...
                    placeholder='Enter the address of the property' height="45px" border=" 1px solid #000 " /> 
                <div className="w-full h-auto pt-2">
