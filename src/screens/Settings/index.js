    ...
    <Layout>
      ...
      <div className="w-full mt-6 h-fit flex pb-6">
        <button
          ...
          style={
            tab === 0
              ? { borderBottom: '2px solid #0984D6 ', color: '#0984D6' }
              : { borderBottom: '2px solid #101010 ' }
          }
          className={tab === 0 ? ' w-40  ' : ' w-40 border-opacity-50'}
        >
        ...
        <button
          ...
          className={tab === 1 ? ' w-40  ' : ' w-40 border-opacity-50'}
        >
        ...
        <button
          ...
          className={tab === 2 ? ' w-48  ' : ' w-48 border-opacity-50'}
        >
        ...
        <button
          ...
          className={tab === 3 ? ' w-40  ' : ' w-40 border-opacity-50'}
        >
        ...
        <button
          ...
          className={tab === 4 ? ' w-40  ' : ' w-40 border-opacity-50'}
        >
